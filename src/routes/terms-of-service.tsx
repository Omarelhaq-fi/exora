...
export const Route = createFileRoute("/terms-of-service")({
  head: () => ({
    meta: [
      { title: "Exora — Terms of Service" },
      { name: "description", content: "Terms of Service for Exora." },
    ],
  }),
    ...
    <div className="on-landing">
        ...
        <div className="on-hero-inner" style={{ gridTemplateColumns: '1fr', textAlign: 'center' }}>
          <div className="on-hero-copy" style={{ margin: '0 auto' }}>
            ...
            <p className="on-lede" style={{ margin: '0 auto' }}>
              The rules and guidelines for using the Exora platform.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="on-section" style={{ paddingTop: '40px', maxWidth: '800px', margin: '0 auto' }}>
        <div className="policy-content">
          ...
          <p>
            By accessing or using Exora, you agree to be bound by these Terms of Service. If you do not agree to all of the terms and conditions, you must not use our service.
          </p>

          <h3>2. Educational Purpose & Medical Disclaimer</h3>
          <p>
            Exora is designed as an educational tool for university and medical students. The AI-generated flashcards, MCQs, and explanations are for <strong>study purposes only</strong>. Exora does not provide medical advice, diagnosis, or treatment. You must never use the information generated by this platform to make clinical decisions or treat patients. Always refer to official medical literature and consult qualified healthcare professionals.
          </p>

          <h3>3. Acceptable Use</h3>
          <p>
            You agree to use Exora only for lawful purposes. You are strictly prohibited from:
            <ul>
          ...
          <p>
            You retain full ownership of any documents you upload. By uploading content to Exora, you grant us a temporary license to process this data exclusively to generate your study materials. We do not claim ownership over your files or notes.
          </p>

          <h3>5. "As Is" Service</h3>
          <p>
            Exora is provided 100% free of charge and on an "as is" and "as available" basis. While we strive for high accuracy and uptime, we make no warranties that the service will be uninterrupted, error-free, or that the AI-generated content is entirely accurate. You use the service at your own risk.
          </p>
